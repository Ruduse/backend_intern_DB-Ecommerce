...
import { CreateShopVoucherDto } from './dto/create-shopVoucher.dto';
import UpdateShopVoucherDto from './dto/update-shopVoucher.dto';
import ShopVoucherService from './shopVoucher.service';

@ApiTags('ShopVouchers')
...
export default class ShopVoucherController {
  ...
  @Post('')
  @HttpCode(201)
  async create(@Body() body: CreateShopVoucherDto): Promise<any> {
    const result = await this.shopVoucherService.create(body);
  ...
  async update(
    ...
    @Body() body: UpdateShopVoucherDto,
  ): Promise<any> {
    const result = await this.shopVoucherService.updateOneById(id, body);
