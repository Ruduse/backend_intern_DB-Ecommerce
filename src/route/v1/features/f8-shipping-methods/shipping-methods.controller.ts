...
import CreateShippingMethodsDto from './dto/create-shipping-methods.dto';
import UpdateShippingMethodsDto from './dto/update-shipping-methods.dto';
...
export default class ShippingMethodsController {
  ...
  @Post('')
  @HttpCode(201)
  async create(@Body() body: CreateShippingMethodsDto): Promise<any> {
  ...
  async update(
    ...
    @Body() body: UpdateShippingMethodsDto,
  ): Promise<any> {
  ...
  async findOneById(
    ...
    const result = await this.shippingmethodService.findOneById(id, {
      populate,
    });
